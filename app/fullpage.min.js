  ...
  e.fn.fullpage = function (V) {
    function W(n, o) {
      ...
      V.autoScrolling && !V.scrollBar
        ? (Jn.css({ overflow: "hidden", height: "100%" }),
          K(ko.recordHistory, "internal"),
          lo.css({ "-ms-touch-action": "none", "touch-action": "none" }),
          t.length && Nn(t.position().top))
        : (Jn.css({ overflow: "visible", height: "initial" }),
          K(!1, "internal"),
          lo.css({ "-ms-touch-action": "", "touch-action": "" }),
          t.length && Jn.scrollTop(t.position().top));
    }
    function K(e, n) {
    ...
    function ee() {
      var n = e(w).prev(m);
      n.length || (!V.loopTop && !V.continuousVertical) || (n = e(m).last()),
        n.length && ze(n, null, !0);
    }
    function ne() {
      var n = e(w).next(m);
      n.length ||
        (!V.loopBottom && !V.continuousVertical) ||
        (n = e(m).first()),
        n.length && ze(n, null, !1);
    }
    function oe(e, n) {
    ...
    function re(n, o, t) {
      if (!lo.hasClass(c)) {
        ...
        a && oe(a + 1),
          (co = !1),
          e.isFunction(V.afterResize) && n && V.afterResize.call(lo),
          e.isFunction(V.afterReBuild) && !n && V.afterReBuild.call(lo);
      }
    }
    function le(n) {
      var o = Zn.hasClass(l);
      n
        ? o ||
          ...
          e(T).hide(),
          Zn.addClass(l),
          e.isFunction(V.afterResponsive) && V.afterResponsive.call(lo, n))
        : o &&
          (W(ko.autoScrolling, "internal"),
          Q(ko.autoScrolling, "internal"),
          e(T).show(),
          Zn.removeClass(l),
          e.isFunction(V.afterResponsive) && V.afterResponsive.call(lo, n));
    }
    ...
    function ce() {
      V.considerHeader
        ? lo.css({ height: so, position: "relative" })
        : lo.css({ height: "100%", position: "relative" }),
        lo.addClass(a),
        e("html").addClass(d),
        (so = V.considerHeader
          ? X.height() - e(V.header).height()
        ...
        e(m).each(function (n) {
          ...
          o.data("fp-styles", o.attr("style")),
            fe(o, n),
            ue(o, n),
            i > 0 ? de(o, t, i) : V.verticalCentered && yn(o);
        }),
    ...
    function de(n, o, t) {
      ...
      var r = n.find(I);
      r.length &&
      (0 !== e(w).index(m) || (0 === e(w).index(m) && 0 !== r.index()))
        ? Yn(r, "internal")
        : o.eq(0).addClass(u);
    }
    function fe(n, o) {
      o || 0 !== e(w).length || n.addClass(u),
        ...
        void 0 !== V.sectionsColor[o] &&
          n.css("background-color", V.sectionsColor[o]),
        void 0 !== V.anchors[o] && n.attr("data-anchor", V.anchors[o]);
    }
    function ue(n, o) {
      void 0 !== V.anchors[o] && n.hasClass(u) && Sn(V.anchors[o], o),
        V.menu &&
          V.css3 &&
          e(V.menu).closest(r).length &&
          e(V.menu).appendTo(Zn);
    }
    function he() {
      lo.find(V.sectionSelector).addClass(g),
        lo.find(V.slideSelector).addClass(A);
    }
    function ve(e) {
      e
        .find(M)
        ...
        "#fff" != V.controlArrowColor &&
          (e
            .find(N)
            .css(
              "border-color",
              "transparent transparent transparent " + V.controlArrowColor
            ),
          e
            .find(Y)
            .css(
              "border-color",
              "transparent " + V.controlArrowColor + " transparent transparent"
            )),
    ...
    function pe() {
      ...
      var n = e(T);
      n.addClass(function () {
        return V.showActiveTooltip
          ? "fp-show-active " + V.navigationPosition
      ...
      e(T).css("margin-top", "-" + e(T).height() / 2 + "px"),
        e(T).find("li").eq(e(w).index(m)).find("a").addClass(u);
    }
    function ge() {
    ...
    function Se() {
      ...
      n.addClass(v),
        ...
        xe() &&
          e.isFunction(V.afterLoad) &&
          V.afterLoad.call(n, n.data("anchor"), n.index(m) + 1),
        e.isFunction(V.afterRender) && V.afterRender.call(lo);
    }
    function xe() {
      var e = kn(Qe().section);
        ...
        if (
          ...
          y.length && ((h = y.data("anchor")), (f = y.index())),
            uo &&
              ...
              e.isFunction(V.onLeave) && V.onLeave.call(p, g, b, S),
              e.isFunction(V.afterLoad) && V.afterLoad.call(n, x, b),
              Ue(p),
              Ye(n),
              Ne(n),
              Sn(x, b - 1),
              V.anchors.length && (eo = x),
              En(f, h, x, b)),
            clearTimeout(So),
      ...
      if (Oe(o)) {
        ...
        (Eo = a.y),
          ...
          i.find(M).length && t.abs(Io - Mo) > t.abs(Oo - Eo)
            ? !io &&
              t.abs(Io - Mo) > (X.outerWidth() / 100) * V.touchSensitivity &&
              (Io > Mo ? vo.m.right && ie(i) : vo.m.left && ae(i))
            : V.autoScrolling &&
              uo &&
              t.abs(Oo - Eo) > (X.height() / 100) * V.touchSensitivity &&
              (Oo > Eo ? ke("down") : Eo > Oo && ke("up"));
      }
    }
    function Oe(e) {
    ...
    function Me(o) {
      ...
      if (V.autoScrolling && !oo && !a) {
        ...
        return (
          (Bo = i),
          d > 200 && (ho = []),
          uo && Ee(ho, 10) >= Ee(ho, 70) && c && ke(l < 0 ? "down" : "up"),
          !1
        );
      }
    ...
    function ze(n, o, t) {
      if (void 0 !== n) {
        ...
        (l.activeSection.is(n) && !co) ||
          (V.scrollBar &&
            X.scrollTop() === l.dtop &&
            !n.hasClass("fp-auto-height")) ||
          (l.activeSlide.length &&
            ((i = l.activeSlide.data("anchor")), (a = l.activeSlide.index())),
          (e.isFunction(V.onLeave) &&
            !l.localIsResizing &&
            !1 ===
              V.onLeave.call(
                l.activeSection,
    ...
    function qe(n) {
      return (
        n.isMovementUp
          ? e(w).before(n.activeSection.nextAll(m))
          : e(w).after(n.activeSection.prevAll(m).get().reverse()),
        Nn(e(w).position().top),
        He(),
    ...
    function Ve(n) {
      Fe(n),
        e.isFunction(V.afterLoad) &&
          !n.localIsResizing &&
          V.afterLoad.call(n.element, n.anchorLink, n.sectionIndex + 1),
        V.scrollOverflow && V.scrollOverflowHandler.afterLoad(),
    ...
    function ln(n) {
      ...
      var t = n.shiftKey,
        ...
        l = r.length ? r : a,
        s = l.find(To);
      i.length ? i.closest(w, I).length || (i = o(n)) : o(n),
        ((!t && i.is(s.last())) || (t && i.is(s.first()))) &&
          n.preventDefault();
    }
    function sn(e) {
      uo &&
        (e.pageY < Ro && vo.m.up ? ee() : e.pageY > Ro && vo.m.down && ne()),
        (Ro = e.pageY);
    }
    function cn(n, o, t) {
      var i = n.closest(m),
      ...
      o.addClass(u).siblings().removeClass(u),
        ...
        !V.loopHorizontal &&
          V.controlArrows &&
          (i.find(Y).toggle(0 !== a.slideIndex),
          i.find(N).toggle(!o.is(":last-child"))),
        i.hasClass(u) &&
          !a.localIsResizing &&
          En(a.slideIndex, a.slideAnchor, a.anchorLink, a.sectionIndex),
        fn(n, a, !0);
    }
    function dn(n) {
      un(n.slidesNav, n.slideIndex),
        n.localIsResizing ||
          (e.isFunction(V.afterSlideLoad) &&
            V.afterSlideLoad.call(
              n.destiny,
              n.anchorLink,
              n.sectionIndex + 1,
              n.slideAnchor,
    ...
    function yn(e) {
      e.hasClass(R) ||
        e
          .addClass(R)
          .wrapInner(
            '<div class="' + b + '" style="height:' + Cn(e) + 'px;" />'
          );
    }
    function Cn(e) {
      var n = so;
    ...
    function Hn() {
      ...
      (Zn[0].className = Zn[0].className.replace(r, "")),
        Zn.addClass(f + "-" + a);
    }
    function Rn() {
      var e,
      ...
      for (var r in a)
        t.style[r] !== i &&
          ...
          (e = n.getComputedStyle(t).getPropertyValue(a[r])));
      return o.body.removeChild(t), e !== i && e.length > 0 && "none" !== e;
    }
    function zn() {
      o.addEventListener
        ? (o.removeEventListener("mousewheel", Me, !1),
          o.removeEventListener("wheel", Me, !1),
          o.removeEventListener("MozMousePixelScroll", Me, !1))
        : o.detachEvent("onmousewheel", Me);
    }
    function Dn() {
      var e,
        t = "";
      ...
      var a =
        "onwheel" in o.createElement("div")
          ...
          : "DOMMouseScroll";
      "DOMMouseScroll" == a
        ? o[e](t + "MozMousePixelScroll", Me, !1)
        : o[e](t + a, Me, !1);
    }
    function Pn() {
    ...
    function Fn() {
      (ao || ro) &&
        (V.autoScrolling && Zn.off(Co.touchmove).on(Co.touchmove, Le),
        e(r)
          .off(Co.touchstart)
          .on(Co.touchstart, Ie)
          .off(Co.touchmove)
    ...
    function Vn() {
      (ao || ro) &&
        (V.autoScrolling && Zn.off(Co.touchmove),
        e(r).off(Co.touchstart).off(Co.touchmove));
    }
    function jn(e) {
      var n = [];
      return (
    ...
    function Yn(e, n) {
      _(0, "internal"),
        ...
        cn(e.closest(M), e),
        void 0 !== n && (co = !1),
        _(ko.scrollingSpeed, "internal");
    }
    function Nn(e) {
      var n = t.round(e);
      V.css3 && V.autoScrolling && !V.scrollBar
        ? Tn("translate3d(0px, -" + n + "px, 0px)", !1)
        : V.autoScrolling && !V.scrollBar
        ? lo.css("top", -n)
        : Jn.scrollTop(n);
    }
    ...
    function Kn() {
      Nn(0),
        ...
        e(m + ", " + O).each(function () {
          V.scrollOverflowHandler && V.scrollOverflowHandler.remove(e(this)),
            e(this).removeClass(R + " " + u),
    ...
    function Qn() {
      ...
      V.continuousVertical &&
        (V.loopTop || V.loopBottom) &&
        ((V.continuousVertical = !1),
        Gn(
          "warn",
        ...
        e.each(V.anchors, function (n, o) {
          ...
          (i.length || t.length) &&
            ...
            i.length &&
              Gn(
                "error",
                '"' + o + '" is is being used by another element `id` property'
              ),
            t.length &&
              Gn(
                "error",
    ...
    var eo,
      ...
      ho = [],
      vo = {};
    (vo.m = { up: !0, down: !0, left: !0, right: !0 }),
      (vo.k = e.extend(!0, {}, vo.m));
    var po,
      go,
      mo,
      wo,
      ...
      Co = {
        touchmove: "ontouchmove" in n ? "touchmove" : yo.move,
        touchstart: "ontouchstart" in n ? "touchstart" : yo.down,
      },
      To =
    ...
    Qn(),
      ...
      e(this).length &&
        ...
        (function () {
          V.css3 && (V.css3 = Rn()),
            (V.scrollBar = V.scrollBar || V.hybrid),
            se(),
            ce(),
            Z(!0),
            W(V.autoScrolling, "internal"),
            vn(),
            Hn(),
            "complete" === o.readyState && Ke(),
            X.on("load", Ke);
        })(),
        (function () {
